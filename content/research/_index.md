...
4. [Ning He](https://hening.org/) and Jiawei Fu. "**Manipulation by Design: Performance Incentives and Adverse Selection in Bureaucracy**"{{< staticref "pdf/gdp_manipulation.pdf" "newtab">}}[pdf]{{< /staticref >}} [[ssrn]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7278859)
...
3. R package for statistical inference involving small cluster sizes (smaller than 50) [\[github\]](https://github.com/Jiawei-Fu/clusterinfer)
